<template>
  <div class="aside aside-left d-flex flex-column" id="kt_aside" ref="kt_aside">
    ...
    >
      <!--begin::Logo-->
      <div
        class="btn p-0 symbol symbol-60 symbol-light-success"
    ...
    >
      ...
      <ul class="nav flex-column">
        <!--begin::Item-->
        <li class="nav-item mb-2" v-b-tooltip.hover.right="'Dashboard'">
          <router-link
            to="/dashboard"
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="nav-item mb-2" v-b-tooltip.hover.right="'Features'">
          <a
            href="#"
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="nav-item mb-2" v-b-tooltip.hover.right="'Reports'">
          <a
            href="#"
            class="nav-link btn btn-icon btn-hover-text-primary btn-lg"
            data-toggle="tab"
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="nav-item mb-2" v-b-tooltip.hover.right="'Staff Management'">
          <a
            href="#"
            class="nav-link btn btn-icon btn-hover-text-primary btn-lg"
            data-toggle="tab"
