<template>
  ...
  <div class="card card-custom bg-radial-gradient-danger gutter-b card-stretch">
    ...
    <div class="card-header border-0 py-5">
      <h3 class="card-title font-weight-bolder text-white">Employees</h3>
      ...
      <div class="card-spacer bg-white card-rounded flex-grow-1">
        ...
        <div class="row m-0">
          <div class="col px-8 py-6 mr-8">
            ...
            <div class="font-size-h4 font-weight-bolder">50 Years</div>
          </div>
          <div class="col px-8 py-6">
            <div class="font-size-sm text-muted font-weight-bold">
              Average Service
            </div>
            <div class="font-size-h4 font-weight-bolder">30 Years</div>
          </div>
        </div>
        <!--end::Row-->
        <!--begin::Row-->
        <div class="row m-0">
          <div class="col px-8 py-6 mr-8">
            ...
            <div class="font-size-h4 font-weight-bolder">5</div>
          </div>
          <div class="col px-8 py-6">
            <div class="font-size-sm text-muted font-weight-bold">
              No of Directors
            </div>
            <div class="font-size-h4 font-weight-bolder">7</div>
          </div>
        </div>
        <!--end::Row-->
      </div>
