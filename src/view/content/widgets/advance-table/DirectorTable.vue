                  ...
                  <div class="d-flex flex-column w-100 mr-2">
                    ...
                    <div class="progress progress-xs w-100">
                      <div
                        class="progress-bar"
                        role="progressbar"
                        :style="{ width: item.text8 }"
                        v-bind:class="`bg-${item.text9}`"
                        aria-valuenow="50"
                        aria-valuemin="0"
                        aria-valuemax="100"
                      ></div>
...
<script>
// import { SET_ALL_DIRECTORS } from "@/core/services/store/director.module";
import Pagination from "@/view/content/widgets/reusables/Pagination.vue";
// import { mapGetters } from "vuex";
// import { mutations} from "@/core/services/store/directors/moduleDirector.js";
export default {
  data() {
    return {
      checked: false,
      list: [
        ...
        },
        {
          ...
          text1: "Jacob Harrison",
          text2: "Director",
          text3: "jacobharrison@gmail.com",
          text4: "mail",
          text5: "08065452888",
          text6: "phone",
          text7: "Male",
  ...
  computed: {
    // ...mapGetters({ directors: "getdirectors" })
  },

  // mounted() {
  //   this.$store.dispatch(SET_ALL_DIRECTORS);
  // },
