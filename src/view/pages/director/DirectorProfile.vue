        ...
        <div class="card-body pt-4">
          ...
          <div class="d-flex align-items-center">
            ...
            <div>
              <a
                ...
                >Adelaja Dare</a
              >
              <div class="text-muted">Director</div>
              <!-- <div class="mt-2">
                <a
          ...
          <div class="py-9">
            <div class="d-flex align-items-center justify-content-between mb-2">
              ...
              <a class="text-muted text-hover-primary">adelaja@gmail.com</a>
            </div>
            <div class="d-flex align-items-center justify-content-between mb-2">
              <span class="font-weight-bold mr-2">Phone:</span>
              <span class="text-muted">08075635333</span>
            </div>
          ...
          >
            ...
            <div class="navi-item mb-2">
              ...
              >
                ...
                <span class="navi-text font-size-lg">Next of Kin</span>
              </a>
            </div>
            <div class="navi-item mb-2">
              <a
              ...
              >
                ...
                <span class="navi-text font-size-lg">Work Experience</span>
...
import KTPersonalInformation from "@/view/pages/director/profile-components/PersonalDetails";
import KTAccountInformation from "@/view/pages/director/profile-components/NextOfKin";
import KTChangePassword from "@/view/pages/director/profile-components/WorkDetails";
import KTEmailSettings from "@/view/pages/director/profile-components/EducationDetails";
