<template>
  <div>
    ...
    <!-- <div class="row">
      ...
      <div class="col-xl-4">
        <ListLightWidget4></ListLightWidget4>
      </div>
    </div> -->
    <!--end::Row-->
    <!--begin::Row-->
...
import AdvancedTableWidget2 from "@/view/content/widgets/advance-table/DashboardTable.vue";
// import AdvancedTableWidget3 from "@/view/content/widgets/advance-table/Widget3.vue";
// import ListLightWidget4 from "@/view/content/widgets/list-light/Widget4.vue";
import ListWidget2 from "@/view/content/widgets/list/ChartWidget.vue";
