  ...
  routes: [
    {
      ...
      children: [
        ...
        },
        {
          path: "/directors",
          name: "director",
          component: () => import("@/view/pages/director/Director.vue"),
          children: [
            {
              path: "create",
              name: "director-create",
              component: () =>
                import("@/view/pages/director/CreateDirector.vue")
            },
            {
              path: "records",
              name: "director-record",
              component: () =>
                import("@/view/pages/director/DirectorRecords.vue")
            },
            {
              path: "profile",
              name: "director-profile",
              component: () =>
                import("@/view/pages/director/DirectorProfile.vue")
            }
          ]
        },
        {
          ...
          children: [
            {
              ...
              component: () => import("@/view/pages/data-entry/CreateEntry.vue")
            },
            {
              path: "records",
              name: "data-entry-record",
              component: () =>
                import("@/view/pages/data-entry/EntryRecords.vue")
            }
          ]
        },
        {
